...
def main() -> None:
    ...
    for _, row in all_df.iterrows():
        ...
        meta = {
            ...
            "elevation_mean_m": _safe_float(row.get("elevation_mean_m")),
            ...
            "landform_type": _safe_str(row.get("landform_type")),
            "slope_class": _safe_str(row.get("slope_class")),
            "aspect_class": _safe_str(row.get("aspect_class")),
            "slope_position_class": _safe_str(row.get("slope_position_class")),
