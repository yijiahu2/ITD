        ...
        records.append(
            {
                ...
                "recommended_action": {"mode": "readonly_suggestion", "description": f"Use V2 evidence to inspect {family} cases before V3 policy activation."},
                "evidence_summary": {"support_count": len(trajectory_ids), "failure_family": family},
                "safety_constraints": {
                    "status_must_not_be": "active_hard_policy",
                    "v2_does_not_modify_route_map": True,
