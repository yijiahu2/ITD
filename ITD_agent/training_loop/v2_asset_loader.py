...
def load_v2_review_assets(*, v2_review_dir: str | Path, target_cfg: dict[str, Any], output_dir: str | Path) -> dict[str, Any]:
    review_dir = Path(v2_review_dir)
    ...
    imported_samples = [
        _convert_v2_sample_to_finetune_pool_sample(
            sample,
    ...
    snapshot = {
        ...
        "trigger_reason": "v3_loaded_from_v2_review_assets",
        ...
        "metadata": {"v2_review_dir": str(review_dir), "asset_summary": asset_summary},
    }
    write_json(records_dir / "latest_trigger_snapshot.json", snapshot)
    write_json(
        out_dir / "trigger" / "v2_asset_load_report.json",
        {
            "v2_review_dir": str(review_dir),
...
def _convert_v2_sample_to_finetune_pool_sample(
    sample: dict[str, Any],
    *,
    ...
    return {
        ...
        "source_type": sample.get("sample_type") or "v2_approved_sample",
        ...
        "metadata": {
            "source": "v2_review_finetune_pool",
